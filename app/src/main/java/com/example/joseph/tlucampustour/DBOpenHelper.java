...
class DBOpenHelper extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        TourStop aTTScience = new TourStop("AT&T & Moody Science Complex", 29.57098, -97.98293,29.57098, -97.98293, 29.57098, -97.98293, 45, R.string.att_science_info, R.drawable.att_science, R.raw.att_science, 1);
        TourStop emmaFrey = new TourStop("Emma Frey", 29.57148, -97.98263, 29.57094, -97.98385, 29.5711, -97.98394, 30, R.string.emma_frey_info, R.drawable.emma_frey, R.raw.emma_frey, 1);
        TourStop tschoepeHall = new TourStop("Tschoepe Hall", 29.57206, -97.98265, 29.57206, -97.98265, 29.57206, -97.98265, 40, R.string.tschoepe_info, R.drawable.tschoepe, R.raw.tschope, 1);
        ...
        TourStop chapel = new TourStop("Chapel of the Abiding Presence", 29.57262, -97.98376, 29.57262, -97.98376, 29.57262, -97.98376, 30, R.string.chapel_info, R.drawable.chapel, R.raw.chapel, 1);
        ...
        TourStop heinDining = new TourStop("Hein Dining Hall", 29.57208, -97.98512, 29.57208, -97.98512, 29.57208, -97.98512, 45, R.string.hein_info, R.drawable.hein_dining_hall, R.raw.hein_dining_hall, 1);
        ...
        TourStop asc = new TourStop("Alumni Student Center", 29.57331, -97.9836, 29.57331, -97.9836, 29.57331, -97.9836, 40, R.string.asc_info, R.drawable.asc, R.raw.asc, 1);
        TourStop library = new TourStop("Blumburg Memorial Library", 29.57323, -97.98262, 29.57323, -97.98262, 29.57323, -97.98262, 40, R.string.library_info, R.drawable.blumberg_library, R.raw.blumburg_library, 1);
        TourStop schuechFA = new TourStop("Schuech Fine Arts", 29.57332, -97.98161, 29.57332, -97.98161, 29.57332, -97.98161, 50, R.string.scheuch_info, R.drawable.schuech_fine_arts, R.raw.schuech_fine_arts, 1);
        TourStop langnerHall = new TourStop("Langner Hall", 29.57239, -97.98145, 29.57239, -97.98145, 29.57239, -97.98145, 30, R.string.langner_info, R.drawable.langner_hall, R.raw.langner_hall, 1);
